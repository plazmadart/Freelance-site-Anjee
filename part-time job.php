...
<head>
    ...
    <title>Подработка</title>
    <link rel="stylesheet" href="css/part-time job.css" type="text/css">
</head>
<body>
    <div class="container">
        <!-- Шапка и категория -->
        ...
        <section class="main">
            <img src="img/" alt="">
            <div class="category-name"><p>Подработка</p></div>
        </section>
    </div>
